...
<script>
var formObj = "";
formObj = document.querySelector('form[role="form"]');


function modify_go(){
	formObj.setAttribute('action', 'modifyForm.do');
	formObj.submit();
};
...
function remove_go(){
	...
	if(answer){ 
	//formObj.setAttribute({'action':'remove.do','method':'post'});
	formObj.setAttribute('action', 'remove.do');
	formObj.submit();
	}else{
		formObj.setAttribure('method','post');
	}
};
